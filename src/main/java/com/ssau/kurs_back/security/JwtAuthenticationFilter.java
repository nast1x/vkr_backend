...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // 1. Пробуем взять токен из Authorization header
        ...
        if (token == null) {
            token = cookieUtils.getTokenFromCookie(request.getCookies(), "access_token");
        }

        // 3. Проверяем токен и устанавливаем аутентификацию
        if (token != null
